...
const MODULES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "customers.delete", label: "Delete", description: "Permanently delete customers", dangerous: true },
      ...
      { key: "customers.cancel", label: "Cancel subscription", description: "Cancel customer subscriptions" },
